...
COPY --chown=paddleocr:paddleocr config/pipeline_config_vllm.yaml /home/paddleocr
COPY --chown=paddleocr:paddleocr config/pipeline_config_fastdeploy.yaml /home/paddleocr
